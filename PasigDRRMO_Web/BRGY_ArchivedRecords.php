...
<head>
    ...
    <title> PCDRRMO | BRGY Archived Records </title>
    <link rel="stylesheet" href="BRGY_ArchivedRecords55.css">
...
<section class="home-section">
    ...
    <div class="x-account">
        <a href="BRGY_Records.php" class="x-link">X</a>
    </div>
    </div> 
    ...
    $restore_sql = "INSERT INTO brgy_incidentreport (Reference, Date, Location, Involve, Time_Received, Time_Finish) SELECT Reference, Date, Location, Involve, Time_Received, Time_Finish FROM brgy_archiverecords WHERE ID = $restore_id";
            ...
            if ($conn->query($restore_sql) === TRUE) {
                $delete_sql = "DELETE FROM brgy_archiverecords WHERE ID = $restore_id";
        ...
        $sql = "SELECT * FROM brgy_archiverecords";
                    ...
                    foreach ($rows as $row) {
                        ...
                        echo "<td> 
                                <div class='btn-container'>
                                    <button class='view-button'><a href='BRGY_ArchivedRecords.php?restore_id=" . $row["ID"] . "' class='restore' type='submit'> <img src='images/restore.png' alt='View Icon'> </button>
                                </div>
                             </td>";
                        echo "</tr>";
                    }
