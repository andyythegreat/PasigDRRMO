...
<head>
    ...
    <link rel="stylesheet" href="C3_Status65.css">
...
<section class="home-section">
        ...
        <form method="post" action="C3_Status.php?id=<?php echo $id; ?>"> 
    ...
    <div class="add-account">
        ...
        <a href="C3_Request.php?id=<?php echo $id; ?>" class="see"> Request </a>
        <a href="C3_RespondingUnit.php?id=<?php echo $id; ?>" class="see">Responding Unit</a>
        <a href="C3_Ongoing.php" class="x-link">X</a>
            ...
            <div class="home-container">
                ...
                <label for="caller">Date & Time:</label>
<input type="datetime-local" id="datetime" name="Date" class="date" value="<?php echo isset($date) ? $date : ''; ?>"> <br>
    
                <label for="caller">Caller:</label>
                <input type="text" id="location" name="Caller" class="location" value="<?php echo isset($caller) ? $caller : ''; ?>"> <br>
                ...
                <input type="text" id="location" name="Location" class="location" value="<?php echo isset($location) ? $location : ''; ?>"> 
                </div>
                
                
<?php

$query = "SELECT DISTINCT Username FROM c3_addaccount WHERE Username LIKE 'BRGY_%' ORDER BY Username ASC";
    ...
    <select id="Barangay" name="Barangay">
        ...
        foreach ($barangays as $barangay): ?>
            <option value="<?php echo htmlspecialchars($barangay); ?>" 
                <?php echo (isset($currentBarangay) && $currentBarangay === $barangay) ? 'selected' : ''; ?>>
...
?>
                ...
                <select id="involve" class="involve"  name="Involve" value="<?php echo isset($involve) ? $involve : ''; ?>
...
<select id="status" class="status" name="Status">
    ...
    <?php foreach ($statuses as $status): ?>
        <option value="<?php echo htmlspecialchars($status['Name']); ?>" <?php if (isset($currentStatus) && $currentStatus == $status['Name']) echo "selected"; ?>>
...
<?php
// Handle the form submission to update BStatus in c3_request
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['ID']) && isset($_POST['Status'])) {
    $id = intval($_POST['ID']);
    $status = $_POST['Status'];

    // Update only BStatus in c3_request using OngoingID (based on c3_locate ID)
    $query = "UPDATE c3_request SET BStatus = ? WHERE OngoingID = ?";
