...
<head>
    ...
    <title> PCDRRMO | C3 Add Announcements </title>
    <link rel="stylesheet" href="C3_Announcements55.css">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['date'], $_POST['subject'], $_POST['message'], $_FILES['photo'])) {
        $date = $_POST['date'];
        ...
        $sql = "INSERT INTO c3_announcement (Date, Subject, Message, Photo) VALUES ('$dateTime', '$subject', '$message', '$target_file')";
        ...
        if (!empty($tokens)) {
            ...
            $error_msg .= "Error: " . $sql . "<br>" . $conn->error . "<br>";
        }
    } else {
        $error_msg .= "One or more required fields are missing.<br>";
    }
}
...
<section class="home-section">
    ...
    <div class="add-account">
        <a href="C3_SeeAnnouncement.php" class="see"> See Announcement </a>
        <a href="C3_TrashbinAnnouncement.php" class="trashbin"> Archived </a>
    </div>
    </div>

        <form id="announcementForm" method="POST" action="C3_Announcements.php" enctype="multipart/form-data">
