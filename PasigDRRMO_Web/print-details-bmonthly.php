...
<div class="logo"> <br> <br>
    ...
    <div class="main-header">
        <div class="header">
            <h1>PCDRRMO - Pasig City Fire Rescue Section  <?php echo $currentYear; ?></h1>
            <h2>Incident Report For The Year 2024 </h2>
        </div>
    </div>
</div>  <br> <br>
        ...
        <tbody>
            <?php foreach ($categories as $month): ?>
                <tr>
                    ...
                    <td class="td1"><?php echo isset($data[$currentYear . '-' . str_pad(array_search($month, $categories) + 1, 2, '0', STR_PAD_LEFT)]) ? $data[$currentYear . '-' . str_pad(array_search($month, $categories) + 1, 2, '0', STR_PAD_LEFT)] : 0; ?></td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
