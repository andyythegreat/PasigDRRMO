...
<head>
    ...
    <link rel="stylesheet" href="C3_Records11.css">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if(isset($_POST['updateId']) && isset($_POST['updateReference']) && isset($_POST['updateDate']) && isset($_POST['updateLocation']) && isset($_POST['updateInvolved']) && isset($_POST['updateTimeReceived']) && isset($_POST['updateTimeFinish'])) {
        ...
        $updateQuery = "UPDATE c3_incidentreport SET Reference='$reference', Date='$date', Location='$location', Involve='$involved', Time_Received='$timeReceived', Time_Finish='$timeFinish' WHERE ID='$id'";
...
if (isset($_GET['archive_id'])) {
    ...
    $username = $_SESSION["Username"];
    $position = $_SESSION["Position"];
    $archive_sql = "INSERT INTO c3_archiverecords (ID, Reference, Date, Location, Involve, Time_Received, Time_Finish)
...
$sql = "SELECT ID, Reference, Date, Type_Accident, Location, Barangay, Involve, Time_Received, Dispatch_Time, Arrived, Time_Finish, Homebase, Action_Taken, Remarks, Resources, Team_Leader, Driver, Fire_Responder FROM c3_incidentreport";
        ...
        <?php
                ...
                if ($result->num_rows > 0) {
                    ...
                    foreach ($rows as $row) {
                        ...
                        <button class='archive-button'><a href='C3_Records1.php?archive_id=" . $row["ID"] . "' class='archive' type='submit'> <img src='images/Archive1.png' alt='Archive Icon'> 
                        </button>
                                </div>
                             </td>";
                        echo "</tr>";
...
<div class="popup-update">
    ...
    <h2>Update Form</h2>
    <form id="updateForm" method="post" action="C3_Records1.php"> <!-- You need to specify the action for the form -->
