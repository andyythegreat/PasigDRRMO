...
<head>
    ...
    <link rel="stylesheet" href="C3_DeclinedReports55.css">
...
$sql_select_declined = "SELECT * FROM c3_breports_declined ORDER BY ID DESC";
$result_declined = $conn->query($sql_select_declined);
?>

<!-- Home Section -->
<section class="home-section">
    <h1> DECLINED BARANGAY REPORTS </h1>

    <div class="home-container1">
    <h2>INFORMATION</h2> 
    <div class="x-account">
        <a href="C3_BReports.php" class="x-link">X</a>
    </div>
    </div> 
