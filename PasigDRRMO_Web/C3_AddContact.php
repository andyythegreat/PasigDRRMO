...
<head>
    ...
    <title> PCDRRMO | C3 Add Hotline </title>
    <link rel="stylesheet" href="C3_AddContact35.css">
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!empty($contactName) && !empty($contactNumber)) {
        ...
        $stmt->bind_param("ss", $contactName, $contactNumber);

        if ($stmt->execute()) {
            echo "<script>alert('Contact information added successfully.');</script>";
        } else {
            echo "<script>alert('Error adding contact information: " . $stmt->error . "');</script>";
        }
...
<div class="home-container1">
  ...
  <form method="POST" action="C3_AddContact.php" enctype="multipart/form-data">
    <label for="contactname">Contact Name:</label>
    <input type="text" id="contactname" name="contactname"> <br> <br>
        
    <label for="contactnumber">Contact Number:</label>
    <input type="text" name="contactnumber" id="contactnumber" maxlength="11" onkeypress="return isNumberKey(event)" required> <br><br>
    ...
    <button type="submit">Submit</button>
            ...
            // Ensure the input length does not exceed 11 characters
