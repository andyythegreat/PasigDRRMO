...
<head>
    ...
    <title> PCDRRMO | C3 Archived Accounts </title>
    <link rel="stylesheet" href="C3_ArchivedAccount35.css">
...
$restore_sql = "INSERT INTO c3_addaccount (ID, Logo, Username, Email, Password) 
SELECT ID, Logo, Username, Email, Password FROM c3_archiveaccount WHERE ID = $restore_id";
    

    if ($conn->query($restore_sql) === TRUE) {
        $delete_sql = "DELETE FROM c3_archiveaccount WHERE ID = $restore_id";
...
$totalRecordsQuery = "SELECT COUNT(*) as total FROM c3_archiveaccount";
$totalRecordsResult = $conn->query($totalRecordsQuery);
$totalRecords = $totalRecordsResult->fetch_assoc()['total'];

$totalPages = ceil($totalRecords / $recordsPerPage);

$sql = "SELECT ID, Logo, Username, Email, Position, Password FROM c3_archiveaccount LIMIT $recordsPerPage OFFSET $offset";
...
<section class="home-section">
    <h1> ACCOUNT ARCHIVED RECORDS </h1>
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        $imagePath = $row['Logo'];
                        // Debugging: output the filename to check
                        echo "<tr>";
                        echo "<td>";
                        ...
                        echo "<td> 
                                <div class='btn-container'>
                                    <button class='view-button'><a href='C3_ArchivedAccount.php?restore_id=" . $row["ID"] . "' class='restore' type='submit'> <img src='images/restore.png' alt='View Icon'> </button>
                                </div>
                             </td>";
                        echo "</tr>";
                    }
