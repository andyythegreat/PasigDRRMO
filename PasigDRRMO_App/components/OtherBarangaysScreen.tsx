...
export const OtherBarangaysScreen = ({ incidents, handleCardPress }: {incidents: any, handleCardPress?: any}) => {
  return (
    <ScrollView style={styles.scrollView}>
      <View style={styles.container}>
        {/* Other Barangays Header */}
        <View style={styles.section}>
          <View style={styles.header}>
            <MaterialCommunityIcons name="fire-truck" size={40} color="#002f6c" />
            <Text style={styles.headerText}>Other Barangays</Text>
          </View>
          <View style={styles.divider} />

          {/* Other Barangay Items */}
          {incidents.length > 0 ? (
            incidents.map((item) => (
            ...
            <Text style={styles.noIncidentsText}>No incidents in other barangays.</Text>
          )}
        </View>
      </View>
    </ScrollView>
